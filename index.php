    ...
    <div class="carousel-inner" role="listbox">
        ...
        ?>
            <div class="carousel-item <?php if ($no == '1') {
                ...
                <img src="assets/image/<?= $isi['gambar']; ?>" alt="First slide" class="img-fluid" style="object-fit:cover;width:100%;height:500px;">
            </div>
        <?php $no++;
        } ?>
    </div>
                ...
                <div class="card-body">
                    <?php if ($_SESSION['USER']) { ?>
                        ...
                        <center>
                            ...
                            <?php } else { ?>
                                <a href="admin/logout.php" class="btn btn-danger text-white btn-block">Logout</a>
                            <?php } ?>
                        </center>
                    <?php } else { ?>
