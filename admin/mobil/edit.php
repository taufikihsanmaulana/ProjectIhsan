                ...
                <form method="post" action="proses.php?aksi=edit&id=<?= $id;?>" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Nama Mobil</label>
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['nama_mobil'];?>" name="nama_mobil" placeholder="Isi Merk">
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Status Mobil</label>
                                <select class="form-control col-sm-9" name="status_mobil">
                                    <option value="" disabled selected>Pilih Status Mobil</option>
                                    <option <?php if($hasil['status_mobil'] == 'Tersedia'){ echo 'selected';}?>>Tersedia</option>
                                    <option  <?php if($hasil['status_mobil'] == 'Tidak Tersedia'){ echo 'selected';}?>>Tidak Tersedia</option>
                                </select>
                            </div>
